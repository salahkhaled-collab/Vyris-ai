...
const MOCK_ITEMS: BrandItem[] = [
  ...
  },
  {
    id: "i4",
    type: "file",
    raw: "vyris-pitch-deck-v3.pdf",
    title: "Vyris Pitch Deck v3",
  ...
  },
  {
    ...
    summary: "45-min conversation on building AI products without a team, and the Vyris origin story.",
    section: "sec-talking",
    createdAt: "May 15",
  },
];
  ...
  return (
    <Panel className="p-6">
      ...
      <textarea
        ...
        placeholder="Paste a tweet, article link, YouTube URL, idea, or anything you've made. vyris will read it, title it, summarize it, and suggest where it belongs."
        rows={4}
      ...
      <div className="flex items-center justify-between mt-3">
        ...
        >
          {loading ? (
            ...
            <><Sparkles className="w-3.5 h-3.5" /> Let Vyris organize this</>
          )}
        </button>
      </div>
    </Panel>
    ...
    <div className="flex items-start gap-4 px-5 py-4 rounded-xl bg-panel-2 border border-brass/20 animate-in fade-in slide-in-from-top-2 duration-300">
      ...
      <div className="flex-1 min-w-0">
        <p className="text-sm font-medium text-ink-text">
          vyris read your content and suggests placing it under{" "}
...
export default function BrandPage() {
  ...
  async function processRawInput(raw: string) {
    ...
    const newItem: BrandItem = {
      ...
      type,
      raw,
      title: isLink ? "New link · Vyris is reading this…" : raw.slice(0, 60) + (raw.length > 60 ? "…" : ""),
      summary: "Vyris analyzed this and categorized it. Edit the title or summary to adjust.",
      section: "",
